...
// Design Name: Writeback Forwarding Unit
// Module Name: WB_Forward
// Project Name: MicroWIP325
// Target Devices: XC7S100-676FGGA-2
// Tool Versions: Xilinx Vivado 2020.2 
// Description: Flush Control Unit is designed to solve control hazards and it discards instructions in 
// IF and ID stages when a jump instruction(J, JR, or BNE) performs.
// 
// Dependencies: Another hazard could happen at the Write Back Stage when writing and 
// reading at the same address. The readout data may not be the correct writing data. 
// To resolve this problem, a WB_Forward unit is designed to forward directly the correct 
// writing data to the output data.
// 
// Revision:
