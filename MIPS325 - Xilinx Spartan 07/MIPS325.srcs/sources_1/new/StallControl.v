...
// Design Name: Stall Control Unit
// Module Name: StallControl
// Project Name: MicroWIP325
// Target Devices: XC7S100-676FGGA-2
// Tool Versions: Xilinx Vivado 2020.2 
// Description: Data hazards which needs stalling 1 cycle happen when the destination register 
// (EX_rt) of the current reading memory instruction  is the same as the  
// source register (ID_rs or ID_rt) of the coming instruction in ID stage except for ID_rt of XORI and 
// LW instructions (where Rt is the destination register not source register with XORI and LW). 
// 
// Dependencies: 
// 
// Revision:
