...
// Design Name: MIPS Pipelined - Wrapper File
// Module Name: MIPSpipline
...
module MIPSpipeline(JRControl, ZeroFlag, OverflowFlag, CarryFlag, NegativeFlag, notZeroFlag, JumpControl,JumpFlush, clk, reset);
output JRControl, ZeroFlag, OverflowFlag, CarryFlag, NegativeFlag, notZeroFlag, JumpControl, JumpFlush;
input clk, reset;
wire [31:0] PC, PCin;
